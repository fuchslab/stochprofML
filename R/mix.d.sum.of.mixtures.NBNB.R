mix.d.sum.of.mixtures.NBNB <-
    function(y, n.vector, p.vector, size.vector, mu.vector){
...
# In that case, it is negative binomially distributed with size size_i and mu
# deviation mu_i.
